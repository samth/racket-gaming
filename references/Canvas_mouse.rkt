...
;Mouse operations
(define (get-click)
  (ready-mouse-click MainWindow))

(define (mouse-click-x mc)  
  (Windowscale (posn-x (mouse-click-posn mc))))

(define (mouse-click-y mc)  
  (Windowscale (- Pixels-y (posn-y (mouse-click-posn mc)))))
